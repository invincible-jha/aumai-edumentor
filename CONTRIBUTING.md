# Contributing to AumAI Edumentor
...
### Setup
```bash
git clone https://github.com/aumai/aumai-edumentor.git
cd aumai-edumentor
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-edumentor/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-edumentor/discussions)
